...
@RestController
@RequestMapping("/api/remote-work-comm-kafka")
public class RemoteWorkCommKafkaResource {

    private final Logger log = LoggerFactory.getLogger(RemoteWorkCommKafkaResource.class);
    ...
    public RemoteWorkCommKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
